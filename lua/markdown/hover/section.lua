...
---@description
--- Everything else about the hover is `lib.nvim.hover` — classification, the
...
--- not path handling.
---
--- Both are registered as previews through `lib.nvim.hover.registry` (see
...
function M.file(target, opts) return require("lib.nvim.hover.preview.text").file(target, opts) end
