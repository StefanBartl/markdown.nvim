---@module 'markdown_nvim.bindings.actions'
...
--- (`markdown_nvim.bindings.keymaps`) bind straight onto these, and the table is
--- re-exported as `require("markdown_nvim").actions` so users can map their own
...
local function head()      return require("markdown_nvim.core.headings") end
local function fold()      return require("markdown_nvim.core.fold") end
local function fold_prev() return require("markdown_nvim.core.fold_prev") end
local function fold_lvl()  return require("markdown_nvim.core.fold_levels") end
local function wrap()      return require("markdown_nvim.core.wrap") end
local function wrap_link() return require("markdown_nvim.core.wrap_link") end
local function handler()   return require("markdown_nvim.handler") end
local function image()     return require("markdown_nvim.handler.image") end
local function anchor()    return require("markdown_nvim.anchor.jump") end
